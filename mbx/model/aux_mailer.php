...
class MailjetMailer
{
     ...
     */
    public function setSender($sender_email, $sender_full_name)
    {
     ...
     */
    public function addRecipient($recipient_email)
    {
     ...
     */
    public function sendMail($do_send)
    {
        if ($do_send)
        {
            $emailMsgList   = array ();
            ...
            curl_setopt($curl_sess, CURLOPT_USERPWD, GlobalParameter::$applicationConfig['mailjetPassword']);
