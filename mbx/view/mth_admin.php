...
<html lang="de">
    ...
    <body>
        <?php FormElements::topNavigationBar('MTH.ADM', $usr_session->isAuthenticated(), $usr_session->getRole()); ?>
        <?php FormElements::bottomNavigationBar('MTH.ADM', $usr_session->isAuthenticated(), $usr_session->getRole()); ?>
