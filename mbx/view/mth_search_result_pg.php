...
class MethodSearchResultView extends MethodSearchViewBase
{    
    protected function renderLine($line_no, $line)
    {
        ...
        $this->addOutput('<tr><th scope="row" class="table-secondary">Beschreibung</th><td colspan=5><span>' . $line->mth_summary . '</span></th></tr>');
        ...
        // Table row 4: field values (social form, elements) + download button
