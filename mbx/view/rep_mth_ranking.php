...
<html lang="de">
    ...
    <body>
        <?php FormElements::persTopNavigationBar('REP.MRNK', $usr_session->isAuthenticated(), $usr_name, $usr_session->getPermissions()); ?>
        <?php FormElements::bottomNavigationBar('REP.MRNK'); ?>
