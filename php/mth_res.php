    ...
    <body>
        ...
        <div class="container" role="main">
            ...
            <?php
                ...
                {
                    echo '<div class="row"><div class="col"><div class="alert alert-warning" role="alert">';
                        ...
                        <tbody>
                            <?php
                                foreach($method_list as $method)
                                {
                                    ...
                                    // Column: Methodenname
                                    echo '<td>';
                                    echo '<button type="button" class="btn btn-light" data-toggle="popover" data-trigger="focus" data-container="body" ' .
                                         'data-placement="right" title="Kurzbeschreibung" data-content="' . $method['mth_summary'] . '">';
                                    ...
                                    {
                                        echo '<span class="label label-info">' . $method['dld_count'] . '</span>';
                                    }
                                    echo '</td>';
                                    ...
                                    if ($method['rtg_count'] != 0)
                                    {
                                        ...
                                        echo '<span class="label label-info">  ' . $method['rtg_count'] . '  </span>';
                                        ...
                                        echo '<span class="label ' . $label_mode . '">  ' . number_format($rtg_avg,2) . '  </span>';
                                    }
                                    echo '</td>';
